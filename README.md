...
This is the working area for the Individual internet-draft, "Cookies".

* [Editor's copy](https://mikewest.github.io/update-rfc6265/)
* [Individual Draft] (https://tools.ietf.org/html/draft-west-update-rfc6265)
...
documents](https://datatracker.ietf.org/wg/update/documents/) and [mailing
list discussion](https://mailarchive.ietf.org/arch/browse/update/). If you're
...
([info](https://www.ietf.org/mailman/listinfo/update)). This will ensure that
